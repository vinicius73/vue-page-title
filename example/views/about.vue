...
const NAMES = ['Luiz Vinicius', 'Vinicius Reis', '@vinicius73'];
...
<template>
  <Hero>
    <div class="page-about">
      ...
      <figure>
        <img
          src="https://gravatar.com/avatar/f803c45d62a468e0cb990398c004bd3e?s=300"
          :alt="actual"
        />
        <figcaption>
          <p>
            I am passionate about coding and open source but has more hobbies
            than time to work on them, with a love for movies, books, manga,
            comics, games and more.
          </p>
          <p>
            You can find my projects on
            <a href="https://github.com/vinicius73" target="_blank">Github</a>
            and my articles on
            <a href="https://dev.to/vinicius73" target="_blank">
              dev.to/vinicius73
            </a>
            and
            <a
          ...
          <p>
            I also have some videos on
            <a href="https://www.youtube.com/c/CODECASTS" target="_blank">
              YouTube
            </a>
            .
          </p>
